--- START OF FILE mao_nav-master/src/views/NavHomeView.vue ---
...
--- START OF FILE mao_nav-master/src/views/AdminView.vue ---
...
--- START OF FILE mao_nav-master/README.md ---
...
- 2025-08-20 增加通用部署支持，可通过环境变量自定义前台和后台标题。
